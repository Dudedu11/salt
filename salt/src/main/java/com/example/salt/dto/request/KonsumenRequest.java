...
public class KonsumenRequest {
    @Size(max = 20, message = "Nama harus punya maksimal 20 karakter")
    @NotBlank(message = "Nama tidak boleh kosong")
    private String nama;

    @Size(max = 20, message = "Alamat harus punya maksimal 20 karakter")
    @NotBlank(message = "Alamat tidak boleh kosong")
    private String alamat;

    @Size(min = 1, max = 1, message = "Kota harus diisi 1 karakter saja")
    @NotBlank(message = "Kota tidak boleh kosong")
    private String kota;

    @Size(min = 1, max = 1, message = "Provinsi harus diisi 1 karakter saja")
